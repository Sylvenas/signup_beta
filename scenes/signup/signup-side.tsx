...
function SignupSide() {
  return (
    <div className="relative hidden h-screen w-[655px] flex-shrink flex-col items-center bg-[#f8f5f4] md:flex">
      <ArcSiteLogo width="153" height="54" className="mt-[40px] block" />
      <img className="absolute left-[5%] top-1/2 w-[115%] -translate-y-[60%]" src={ipadDraw.src} alt="ipad" />
      <div className={twMerge("absolute bottom-[76px] flex w-full flex-col items-center")}>
        <img className="h-[9.6%] w-[35.6%]" src={downPic.src} alt="down"></img>
        <img className="ml-[10%] h-[7.4%] w-[45.5%]" src={star.src} alt="star"></img>
        <img className="h-[1.9%] w-[22.9%]" src={ratings.src} alt="rating"></img>
      </div>
    </div>
  )
}
